...
rofi_command="rofi -dmenu -theme wallpaper.rasi -theme-str ${rofi_override}"
...
swww img ${wall_dir}/${wall_selection} -t wipe --transition-step 30 --transition-duration 1 --transition-fps 120 --transition-angle 30
